package com.machuxin.io.bio.tomcat;
 ...
 */
public class DMTomcat {
    private int port = 8080;
    private ServerSocket server;
    private Map<String, DMServlet> servletMapping = new HashMap<String,DMServlet>();
        ...
        try{
            ...
            for (Object k : webxml.keySet()) {
                ...
                if(key.endsWith(".url")){
                    ...
                    //单实例，多线程
                    DMServlet obj = (DMServlet)Class.forName(className).newInstance();
    ...
    private void process(Socket client) throws Exception {
        ...
        DMRequest request = new DMRequest(is);
        DMResponse response = new DMResponse(os);
